class Thermostat:
    PARAMS = {
        "control_scale": {"prompt": "Control Scale (strength of thermostat effects)", "type": float},
        "response_scale": {"prompt": "Response Scale (high = slow-heating; low = fast-heating)", "type": float},
